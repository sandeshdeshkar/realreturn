...
export const PAGE_CONFIGS: PageConfig[] = [
  ...
  // ── PAGE 1: ₹10,000/month · 10 years ────────────────────────────────────
  {
    ...
    title: '₹10,000/Month SIP vs FD for 10 Years — Real Return After Tax & Inflation',
    metaDescription:
      '₹10,000/month SIP gives ₹22.4L vs FD\'s ₹17.4L over 10 years. After 30% tax and 6% inflation, SIP real return is +4.4%/yr vs FD\'s −1.0%/yr. See the year-by-year breakdown.',
  ...
  // ── PAGE 2: ₹5,000/month · 10 years ────────────────────────────────────
  {
    ...
    title: '₹5,000/Month SIP vs FD for 10 Years — Real Return After Tax & Inflation',
    metaDescription:
      '₹5,000/month SIP gives ₹11.2L vs FD\'s ₹8.7L over 10 years. After 30% tax and 6% inflation, SIP real return is +4.6%/yr vs FD\'s −1.0%/yr. Even a small SIP beats FD — see the real numbers.',
    ...
    breakEvenInsight: {
      ...
      body: 'Whether you invest ₹5,000 or ₹50,000 a month, SIP overtakes FD at the <strong>same point</strong> — break-even depends on return rates and time, not the amount. At 12% SIP / 7% FD, SIP edges ahead from year 1, but the lead is small in early years. The gap accelerates after year 5 and reaches <strong>₹2.5L by year 10</strong> — roughly <strong>4.7 years of your ₹5,000 SIP</strong> sitting extra in your pocket. At 0% tax, FD\'s real return turns slightly positive and the gap narrows.',
    },
    ...
    faqs: [
      {
        ...
        a: 'At a 30% tax slab, yes. ₹5,000/month SIP for 10 years gives ₹11.2L at 12% CAGR vs FD\'s ₹8.7L at 7%. After tax and 6% inflation, SIP\'s real return is +4.6%/yr vs FD\'s −1.0%/yr. Even at 0% tax, SIP outperforms by year 6. Use the tax slider above to see your bracket.',
      },
      {
      ...
      },
      {
        ...
        a: 'Break-even depends on the ratio of returns, not the absolute amount. Whether you invest ₹5,000 or ₹50,000/month, SIP grows at 12% and FD at 7%. The crossover point is set by these rates and time alone. Once SIP overtakes FD, the gap scales proportionally with the amount.',
      },
      {
  ...
  //   metaDescription: '₹10,000/month SIP for 5 years gives ₹8.1L vs FD\'s ₹7.2L. After tax and inflation, SIP real return is +5.1%/yr vs FD\'s −1.0%/yr. Is 5 years enough for SIP?',
  ...
  //   metaDescription: '₹10,000/month SIP for 15 years gives ₹47.6L vs FD\'s ₹31.8L. After tax and inflation, SIP real return is +4.3%/yr. The 15-year compounding story.',
  ...
  //   title: '₹20,000/Month SIP vs FD for 10 Years — Real Return After Tax & Inflation',
  //   metaDescription: '₹20,000/month SIP gives ₹44.8L vs FD\'s ₹34.7L over 10 years. After 30% tax and inflation, SIP real return is +4.3%/yr vs FD\'s −1.0%/yr.',
